...
export class EditInterestsForm extends Component {
    constructor(props){
        super(props)
        this.state = {
            err: '',
    ...
    handleSubmit = (event) => {
        ...
        console.log(token)
        axios.put('http://127.0.0.1:5000/api/edit_interests', { 
...
export default withRouter(EditInterestsForm)
